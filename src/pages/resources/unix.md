...
- [Beej's Guide to Network Programming](https://beej.us/guide/bgnet/html//index.html): This document should give the average competent C programmer the edge s/he needs to get a grip on using internet sockets.
